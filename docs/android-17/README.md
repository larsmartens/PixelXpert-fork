...
- The CI artifact from run `28738543788` is staged on-device with PixelXpert still disabled and `skip_mount` present; see `evidence/pixelxpert-ci-artifact-staged-disabled-20260705.md`.
